    ...
    <div className="min-h-screen">
      ...
      <section id="projetos" className="py-20 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            <h2 className="font-heading text-3xl md:text-4xl font-bold mb-6">Projetos</h2>

            {/* Desenvolvidos */}
            <div className="mb-12">
              <h3 className="font-heading text-2xl font-semibold mb-4">Projetos Desenvolvidos</h3>
              <div className="grid md:grid-cols-2 gap-4">
                {projetosDesenvolvidos.map((p) => (
                  <Card key={p.slug} className="border-2">
            ...
            {/* Em Curso */}
            <div className="mb-8">
              <h3 className="font-heading text-2xl font-semibold mb-4">Projetos em Curso</h3>
              <div className="grid md:grid-cols-2 gap-4">
      ...
      <section className="py-16 px-4">
        <div className="container mx-auto max-w-5xl">
          <h2 className="font-heading text-3xl md:text-4xl font-bold mb-6">Teses e Relatórios</h2>
          <div className="grid md:grid-cols-2 gap-4">
            {tesesRelatorios.map((t) => (
              <Card key={t.title} className="border-2">
                <CardContent className="p-5 flex items-center justify-between">
                  <div>
                    <p className="font-medium">{t.title}</p>
                    <p className="text-sm text-muted-foreground">{t.tipo} • {t.ano}</p>
                  </div>
                  <Link href={t.href} className="text-primary text-sm hover:underline" download>
                    Download
                  </Link>
                </CardContent>
              </Card>
